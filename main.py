...
def save_text():
    ...
    startButton.config(state=NORMAL)
    saveButton.config(state=DISABLED)
    new_data = textarea.get(1.0, END)
    with open("text.txt", "a") as data_file:
        data_file.write(f"\n{new_data}")
...
window.geometry('996x760+200+20')
window.config(background="#ffe6e6")
window.resizable(0, 0)
window.overrideredirect(True)

mainframe = Frame(window, bg="#ffe6e6")
mainframe.grid(row=0, column=0)

titleframe = Frame(mainframe, bd=5, bg="dark red")
titleframe.grid(row=0, column=0)

titlelabel = Label(titleframe, text="💀 Dangerous Writing App 💀", font=(
    'chiller', 25, "bold"), bg="#ff3333", fg="white", width=74, bd=10)
titlelabel.grid(row=0, column=0)

paragraph_frame = Frame(mainframe, bg="#ffe6e6")
paragraph_frame.grid(row=1, column=0, pady=5)

title_label_paragraph = Label(
...
textarea = Text(textarea_frame, font=('arial', 15, 'bold'), width=75,
                height=10, bd=7, relief=GROOVE, wrap="word", state=DISABLED)
textarea.bind("<Key>", reset)
textarea.grid()


button_frame = Frame(mainframe, bg="#ffe6e6")
button_frame.grid(row=3, column=0)

startButton = ttk.Button(button_frame, text="Start", command=start_timer)
startButton.grid(row=0, column=0, padx=10)

saveButton = ttk.Button(button_frame, text="Save", command=save_text)
...
keyboard_frame = Frame(mainframe, bg="#ffe6e6", bd=2, relief=GROOVE)
keyboard_frame.grid(row=4, column=0, pady=3)

frame_1to0 = Frame(keyboard_frame, bg="#ffe6e6")
...
labelbackspace = Label(frame_1to0, text="Backspace", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=10, height=2, bd=10, relief=GROOVE)
labelbackspace.grid(row=0, column=13, padx=3)

frame_qtop = Frame(keyboard_frame, bg="#ffe6e6")
frame_qtop.grid(row=1, column=0, pady=3)

labeltab = Label(frame_qtop, text="Tab", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=8, height=2, bd=10, relief=GROOVE)
labeltab.grid(row=0, column=0, padx=3)
labelq = Label(frame_qtop, text="Q", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelq.grid(row=0, column=1, padx=3)
labelw = Label(frame_qtop, text="W", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelw.grid(row=0, column=2, padx=3)
labele = Label(frame_qtop, text="E", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labele.grid(row=0, column=3, padx=3)
labelr = Label(frame_qtop, text="R", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelr.grid(row=0, column=4, padx=3)
labelt = Label(frame_qtop, text="T", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelt.grid(row=0, column=5, padx=3)
labely = Label(frame_qtop, text="Y", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labely.grid(row=0, column=6, padx=3)
labelu = Label(frame_qtop, text="U", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelu.grid(row=0, column=7, padx=3)
labeli = Label(frame_qtop, text="I", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labeli.grid(row=0, column=8, padx=3)
labelo = Label(frame_qtop, text="O", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelo.grid(row=0, column=9, padx=3)
labelp = Label(frame_qtop, text="P", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
...
frame_atol = Frame(keyboard_frame, bg="#ffe6e6")
frame_atol.grid(row=2, column=0, pady=3)

labelcapslock = Label(frame_atol, text="Caps Lock", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=10, height=2, bd=10, relief=GROOVE)
labelcapslock.grid(row=0, column=0, padx=3)
labela = Label(frame_atol, text="A", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labela.grid(row=0, column=1, padx=3)
labels = Label(frame_atol, text="S", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labels.grid(row=0, column=2, padx=3)
labeld = Label(frame_atol, text="D", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labeld.grid(row=0, column=3, padx=3)
labelf = Label(frame_atol, text="F", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelf.grid(row=0, column=4, padx=3)
labelg = Label(frame_atol, text="G", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelg.grid(row=0, column=5, padx=3)
labelh = Label(frame_atol, text="H", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelh.grid(row=0, column=6, padx=3)
labelj = Label(frame_atol, text="J", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelj.grid(row=0, column=7, padx=3)
labelk = Label(frame_atol, text="K", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelk.grid(row=0, column=8, padx=3)
labell = Label(frame_atol, text="L", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
...
labelenter = Label(frame_atol, text="Enter", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=13, height=2, bd=10, relief=GROOVE)
labelenter.grid(row=0, column=12, padx=3)

frame_ztom = Frame(keyboard_frame, bg="#ffe6e6")
frame_ztom.grid(row=3, column=0, pady=3)

labelshift1 = Label(frame_ztom, text="Shift", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=16, height=2, bd=10, relief=GROOVE)
labelshift1.grid(row=0, column=0, padx=3)
labelz = Label(frame_ztom, text="Z", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelz.grid(row=0, column=1, padx=3)
labelx = Label(frame_ztom, text="X", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelx.grid(row=0, column=2, padx=3)
labelc = Label(frame_ztom, text="C", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelc.grid(row=0, column=3, padx=3)
labelv = Label(frame_ztom, text="V", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelv.grid(row=0, column=4, padx=3)
labelb = Label(frame_ztom, text="B", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labelb.grid(row=0, column=5, padx=3)
labeln = Label(frame_ztom, text="N", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
labeln.grid(row=0, column=6, padx=3)
labelm = Label(frame_ztom, text="M", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=5, height=2, bd=10, relief=GROOVE)
...
labelshift2 = Label(frame_ztom, text="Shift", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=16, height=2, bd=10, relief=GROOVE)
labelshift2.grid(row=0, column=12, padx=3)

spaceframe = Frame(keyboard_frame, bg="#ffe6e6")
spaceframe.grid(row=4, column=0, pady=3)

labelctrl_l = Label(spaceframe, text="Ctrl", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=10, height=2, bd=10, relief=GROOVE)
labelctrl_l.grid(row=0, column=0, padx=6)
labelalt_l = Label(spaceframe, text="Alt", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=10, height=2, bd=10, relief=GROOVE)
labelalt_l.grid(row=0, column=1, padx=6)
labelspace = Label(spaceframe, text="Space", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=50, height=2, bd=10, relief=GROOVE)
labelspace.grid(row=0, column=2, padx=6)
labelalt_r = Label(spaceframe, text="Alt", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=10, height=2, bd=10, relief=GROOVE)
labelalt_r.grid(row=0, column=3, padx=6)
labelctrl_r = Label(spaceframe, text="Ctrl", bg="black", fg="white", font=(
    'arial', 10, 'bold'), width=10, height=2, bd=10, relief=GROOVE)
...
def caps_lock_on(e):
    labelcapslock.config(bg="red")


def caps_lock_off(e):
    labelcapslock.config(bg="black")


def alt_r_click(e):
    labelalt_r.config(bg="red")
    labelctrl_l.config(bg="black")
    labelalt_r.after(100, lambda: labelalt_r.config(bg="black"))
